...
func (x *AddMessageRequest) GetLink() string {
	if x != nil {
		return x.Link
	}
	return ""
...
func (x *AddMessageRequest) GetFakeLink() string {
	if x != nil {
		return x.FakeLink
	}
	return ""
...
var file_link_service_link_service_proto_rawDesc = string([]byte{
	...
	0x73, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x43, 0x0a, 0x11, 0x41, 0x64, 0x64, 0x4d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x6c,
	...
	0x12, 0x58, 0x0a, 0x0a, 0x41, 0x64, 0x64, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x1f,
...
var file_link_service_link_service_proto_goTypes = []any{
	...
	(*AddMessageRequest)(nil),     // 3: link_service.AddMessageRequest
...
var file_link_service_link_service_proto_depIdxs = []int32{
	...
	3, // 3: link_service.LinkService.AddMessage:input_type -> link_service.AddMessageRequest
	...
	5, // 6: link_service.LinkService.AddMessage:output_type -> google.protobuf.Empty
